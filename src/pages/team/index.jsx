const Team = () => {
  return (
    <section id="team">
    <div class="flex items-center justify-center min-h-screen py-48 m-4 rounded-xl">
      <div class="flex flex-col">
        <div class="flex flex-col mt-8">
          <div class="container max-w-7xl px-4">
            <div class="flex flex-wrap justify-center text-center mb-24">
              <div class="w-full lg:w-6/12 px-4">
                <h1 class=" font-bold mb-8 text-blue-500 mt-12 text-center text-4xl  ">
                  Meet the Team
                </h1>
                <p class="text-gray-700 text-4xl font-light">
